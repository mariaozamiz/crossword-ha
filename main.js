...
function getXCells(td) {
    ...
    //Get previous
    while (curr.previousElementSibling && !curr.previousElementSibling.classList.contains("cell-black")) {
    ...
    //Get next
    curr = td;
    while (curr.nextElementSibling && !curr.nextElementSibling.classList.contains("cell-black")) {
...
function getYCells(td) {
    ...
    //Get previous
    while (tr.previousElementSibling && !tr.previousElementSibling.children[index].classList.contains("cell-black")) {
        tr = tr.previousElementSibling;
    ...
    //Get next
    tr = td.parentElement;
    while (tr.nextElementSibling && !tr.nextElementSibling.children[index].classList.contains("cell-black")) {
        tr = tr.nextElementSibling;
